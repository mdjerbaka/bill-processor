...
export const recurringBillsAPI = {
  ...
  toggleActive: (id) => api.patch(`/recurring-bills/${id}/toggle-active`),
  ...
  getMasterList: (includeInactive = false) => api.get('/recurring-bills/master-list', { params: { include_inactive: includeInactive } }),
  markCurrentPaid: (billId, body) => api.post(`/recurring-bills/${billId}/mark-current-paid`, body || null),
...
export const receivablesAPI = {
  ...
  markPaid: (id) => api.post(`/receivables/${id}/mark-paid`),
  markUnpaid: (id) => api.post(`/receivables/${id}/mark-unpaid`),
